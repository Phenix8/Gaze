package com.ican.dlibwrapper.camera;
...
import com.ican.dlibwrapper.DLibWrapper;
import com.ican.dlibwrapper.R;
...
public class CameraFragment extends Fragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new CameraFragment.ImageTester(reader.acquireNextImage(), mFile, getActivity()));
        }
    ...
    private boolean setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (sizes == null) {
                    CameraFragment.ErrorDialog.newInstance("FLEX_RGB_888 unsupported")
                            .show(getChildFragmentManager(), FRAGMENT_DIALOG);
                    return false;
                }
            ...
            CameraFragment.ErrorDialog.newInstance(getString(R.string.camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } catch (Exception e) {
            CameraFragment.ErrorDialog.newInstance(e.getLocalizedMessage())
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    ...
    private static class ImageTester implements Runnable {
        ...
        public void run() {
            try {
                int result = DLibWrapper.getInstance().checkForObjects(mImage, mActivity);
