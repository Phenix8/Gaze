...
{  
    try
    {
        ...
        parser.add_option("hogs", "Display the given detector histograms of gradient.");
        ...
        else if (parser.option("hogs")) {
            if (tolower(right_substr(parser[0],".")) == "svm") {
                ...
                cout << "Please give a .svm file." << endl;
                return EXIT_FAILURE;
            }
        }
